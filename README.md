...
- Semiconductor basics -photon energy, phonon energy, energy vs momentum (k) diagram for an indirect bandgap semiconductor, Carrier mobility and applied electronic field, current-voltage (I-V) curve for a pn junction, electron concentration and inverse temperature for an intrinsic semiconductor
